...
public class SavePosition_bike : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        FILE_NAME = "Data_Unity\\"  + DateTime.Now.ToString("yyyyMMddTHHmmssffffff") + "_" + sceneName.ToString() + ".csv";
        ...
        sw.WriteLine("timestamp,timestamp2,data_time," + "camposition.x , camposition.y, camposition.z," + "Camera.facing.x," + "Camera.facing.y," + "Camera.facing.z," 
...
StreamWriter sw = File.AppendText(FILE_NAME);
        ...
        sw.WriteLine(timestamp + "," + unixTimeMilliseconds + "," + data_time + "," + camposition.x + "," + camposition.y + "," + camposition.z + ","
