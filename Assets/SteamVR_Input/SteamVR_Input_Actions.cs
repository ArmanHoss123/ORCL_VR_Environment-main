...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Action_Vector2 p_default_TrackpadLeft;
        
        private static SteamVR_Action_Vector2 p_default_TrackpadRight;
        ...
        private static SteamVR_Action_Boolean p_platformer_Sprint;
        
        private static SteamVR_Action_Boolean p_platformer_MoveClick;
        ...
        private static SteamVR_Action_Vector2 p_oRCL_TouchpadPosition;
        
        private static SteamVR_Action_Boolean p_oRCL_Touchpadtouch;
        ...
        public static SteamVR_Action_Vector2 default_TrackpadLeft
        {
            get
            {
                return SteamVR_Actions.p_default_TrackpadLeft.GetCopy<SteamVR_Action_Vector2>();
            }
        }
        
        public static SteamVR_Action_Vector2 default_TrackpadRight
        {
            get
            {
                return SteamVR_Actions.p_default_TrackpadRight.GetCopy<SteamVR_Action_Vector2>();
            }
        }
        ...
        public static SteamVR_Action_Boolean platformer_Sprint
        {
            get
            {
                return SteamVR_Actions.p_platformer_Sprint.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        
        public static SteamVR_Action_Boolean platformer_MoveClick
        {
            get
            {
                return SteamVR_Actions.p_platformer_MoveClick.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        ...
        public static SteamVR_Action_Vector2 oRCL_TouchpadPosition
        {
            get
            {
                return SteamVR_Actions.p_oRCL_TouchpadPosition.GetCopy<SteamVR_Action_Vector2>();
            }
        }
        
        public static SteamVR_Action_Boolean oRCL_Touchpadtouch
        {
            get
            {
                return SteamVR_Actions.p_oRCL_Touchpadtouch.GetCopy<SteamVR_Action_Boolean>();
            }
        }
        ...
        private static void InitializeActionArrays()
        {
            Valve.VR.SteamVR_Input.actions = new Valve.VR.SteamVR_Action[] {
                    ...
                    SteamVR_Actions.platformer_Sprint,
                    SteamVR_Actions.platformer_MoveClick,
                    SteamVR_Actions.buggy_Steering,
                    SteamVR_Actions.buggy_Throttle,
                    SteamVR_Actions.buggy_Brake,
                    SteamVR_Actions.buggy_Reset,
                    SteamVR_Actions.mixedreality_ExternalCamera,
                    SteamVR_Actions.oRCL_TouchpadPosition,
                    SteamVR_Actions.oRCL_Touchpadtouch};
        ...
        private static void PreInitActions()
        {
            ...
            SteamVR_Actions.p_default_TrackpadLeft = ((SteamVR_Action_Vector2)(SteamVR_Action.Create<SteamVR_Action_Vector2>("/actions/default/in/TrackpadLeft")));
            SteamVR_Actions.p_default_TrackpadRight = ((SteamVR_Action_Vector2)(SteamVR_Action.Create<SteamVR_Action_Vector2>("/actions/default/in/TrackpadRight")));
            SteamVR_Actions.p_default_Haptic = ((SteamVR_Action_Vibration)(SteamVR_Action.Create<SteamVR_Action_Vibration>("/actions/default/out/Haptic")));
            SteamVR_Actions.p_platformer_Move = ((SteamVR_Action_Vector2)(SteamVR_Action.Create<SteamVR_Action_Vector2>("/actions/platformer/in/Move")));
            SteamVR_Actions.p_platformer_Jump = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/platformer/in/Jump")));
            SteamVR_Actions.p_platformer_Sprint = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/platformer/in/Sprint")));
            SteamVR_Actions.p_platformer_MoveClick = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/platformer/in/MoveClick")));
            ...
            SteamVR_Actions.p_oRCL_TouchpadPosition = ((SteamVR_Action_Vector2)(SteamVR_Action.Create<SteamVR_Action_Vector2>("/actions/ORCL/in/TouchpadPosition")));
            SteamVR_Actions.p_oRCL_Touchpadtouch = ((SteamVR_Action_Boolean)(SteamVR_Action.Create<SteamVR_Action_Boolean>("/actions/ORCL/in/Touchpadtouch")));
        }
    }
}
